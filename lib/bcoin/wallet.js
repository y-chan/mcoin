 ...
 * @param {BN?} fee - Use a hard fee rather than calculating one.
 * @param {Number} subtractFee - Whether to subtract the fee from
 * existing outputs rather than adding more inputs.
 */

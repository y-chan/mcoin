 ...
 * @constructor
 * @param {Buffer[]|Buffer} items - Array of stack items or raw witness buffer.
 */
...
/**
 * Parse a bitcoind formatted script
 ...
 * @constructor
 * @param {Buffer|Array|Object} code - Array
...
/**
 * @typedef OutputScriptOptions
 * @type Object
 * @property {String?} address - Base58 address to send to.
 * @property {Buffer?} flags - Nulldata flags.
 * @property {Buffer?} key - Key for pay-to-pubkey.
 * @property {Buffer?} keyHash - Key has for pay-to-pubkeyhash.
 * @property {Buffer[]?} keys - Keys for pay-to-multisig.
 * @property {Boolean|Buffer[]} - Whether to create a scripthash
 * or the scripthash itself.
 */
 ...
 * @param {OutputScriptOptions} options
 * @returns {Script}
 */

...
ChainDB.prototype.getTransactionsByAddress = function getTransactionsByAddress(addresses, callback) {
  var self = this;
  var hashes = [];
  var txs = [];
  var have = {};
...
ChainDB.prototype.getTransaction = function getTransaction(hash, callback) {
  var self = this;
  var key = 't/t/' + hash;
  var tx;
...
ChainDB.prototype.hasTransaction = function hasTransaction(hash, callback) {
...
ChainDB.prototype.getFullTransaction = function getFullTransaction(hash, callback) {
  var self = this;
...
ChainDB.prototype._getTransaction = function _getTransaction(hash, callback) {
...
ChainDB.prototype.isUnspentTransaction = function isUnspentTransaction(hash, callback) {
  if (this.options.spv)
    return callback(null, false);

  return this.isSpentTransaction(hash, function(err, spent) {
    if (err)
      return callback(err);
...
ChainDB.prototype.isSpentTransaction = function isSpentTransaction(hash, callback) {
  if (hash.hash)
    hash = hash.hash('hex');

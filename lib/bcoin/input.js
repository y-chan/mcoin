...
Outpoint.prototype.isNull = function isNull() {
  return this.index === 0xffffffff
    && utils.equal(this.hash, constants.ZERO_HASH);
};
...
Outpoint.prototype.hex = function hex() {
  return this.hash.toString('hex');
};

Outpoint.prototype.key = function key() {
  return this.hash.toString('hex') + '/' + this.index;
};
...
Outpoint.prototype.inspect = function inspect() {
  return '<Outpoint: ' + this.hex() + '/' + this.index + '>';
};

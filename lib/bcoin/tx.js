 ...
 * @property {String|null} block - Hash of the block the transaction
 * was included in.
 ...
 * @property {String|null} rblock - Reversed block hash (uint256le).
 * @property {String} rhash - Reversed transaction hash (uint256le).
 * @property {String} rwhash - Reversed witness transaction hash (uint256le).
 ...
 * @returns {String[]} Outpoint hashes.
 */
 ...
 * @returns {Object} A "naked" transaction (a
 ...
 * @param {Buffer} data
 * @param {String?} enc - Encoding, can be `'hex'` or null.
 * @returns {Object} A "naked" transaction object.
 */

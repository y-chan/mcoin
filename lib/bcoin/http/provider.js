...
/**
 * @see HTTPProvider#getTransaction
 */

HTTPProvider.prototype.getTransaction = function getTransaction(hash, callback) {
  return this.client.getWalletTransaction(this.id, hash, callback);
};

...
HTTPClient.prototype.getWalletTransaction = function getTransaction(id, hash, callback) {
...
HTTPClient.prototype.getTransactionsByAddress = function getTransactionsByAddress(address, callback) {
  var body = { addresses: address };
...
HTTPClient.prototype.getTransaction = function getTransaction(hash, callback) {
  hash = utils.revHex(hash);

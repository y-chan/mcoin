 ...
 * @param {Block|MerkleBlock|Buffer|String} hash
 ...
 * @param {Function} callback - Returns [Error, String[]].
 */
 ...
 * @param {(Number|String)?} start - Height or hash to treat as the tip.
 ...
 * @param {String} hash
 * @returns {Object?} root - { root: String, soil: String }.
 */
 ...
 * @param {String[]} locator - Hashes.
 * @param {Function} callback - Returns [Error, String] (the

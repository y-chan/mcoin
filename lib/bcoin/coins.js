 ...
 * @exports Coins
 * @constructor
 * @param {Transaction|Object} tx/options - Transaction or options object.
 ...
 * @param {Coin|Transaction} tx/coin
 * @param {Number?} index
 */
...
Coins.fromTransaction = function fromTransaction(tx) {
  return new Coins(tx, tx.hash('hex'));
};

/**
 * Serialize the coins object.
 * @param {Transaction|Coins} tx
 * @returns {Buffer}
 */

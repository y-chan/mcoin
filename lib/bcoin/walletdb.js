...
/**
 * @see {@link TransactionDB#add}.
 */

WalletDB.prototype.addTransaction = function addTransaction(tx, callback) {
  return this.tx.add(tx, callback);
};

/**
 * @see {@link TransactionDB#getTransaction}.
 */

WalletDB.prototype.getTransaction = function getTransaction(hash, callback) {
  return this.tx.getTransaction(hash, callback);
};

/**
 * @see {@link TransactionDB#getCoin}.
 */
...
/**
 * @see {@link TransactionDB#getHistoryByAddress}.
 */
...
/**
 * @see {@link TransactionDB#getCoinsByAddress}.
 */
...
/**
 * @see {@link TransactionDB#getUnconfirmedByAddress}.
 */
...
/**
 * @see {@link TransactionDB#getBalanceByAddress}.
 */
...
/**
 * @see {@link TransactionDB#getLastTime}.
 */
...
/**
 * @see {@link TransactionDB#getLast}.
 */
...
/**
 * @see {@link TransactionDB#getRange}.
 */
...
/**
 * @see {@link TransactionDB#fillHistory}.
 */
...
/**
 * @see {@link TransactionDB#fillCoins}.
 */
...
Provider.prototype.setID = function setID(id) {
  ...
  this.db.on(id + ' tx', this._onTransaction = function(tx) {
    self.emit('tx', tx);
  });
...
Provider.prototype.destroy = function destroy(callback) {
  ...
  if (this._onTransaction) {
    this.db.removeListener(this.id + ' tx', this._onTransaction);
    delete this._onTransaction;
  }
...
Provider.prototype.getTransaction = function getTransaction(hash, callback) {
  return this.db.getTransaction(hash, callback);
};
...
Provider.prototype.addTransaction = function addTransaction(tx, callback) {

 ...
 * @property {String} prevBlock - Previous block hash.
 ...
 * @property {String?} commitmentHash - Commitment hash for segwit.
 ...
 * @params {Boolean?} scriptHash - Whether to count redeem script ops.
 * @params {Boolean?} accurate - Whether to use accurate counting
